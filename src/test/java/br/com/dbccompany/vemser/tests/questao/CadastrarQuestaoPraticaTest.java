...
class CadastrarQuestaoPraticaTest {
    ...
    void testCadastrarQuestaoPraticaComSucesso() {
        ...
        QuestaoResponse questaoResponse = questaoPraticaClient.criarQuestaoPratica(questao)
                .then()
                .log().all()
    ...
    void testCadastrarQuestaoPraticaSemTitulo() {
        ...
        QuestaoResponse questaoPraticaModel = questaoPraticaClient.criarQuestaoPratica(questao)
                .then()
                .log().all()
                .statusCode(400)
                .extract()
